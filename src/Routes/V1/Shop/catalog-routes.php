 ...
 * Category routes.
 */
Route::controller(CategoryController::class)->prefix('categories')->middleware('cache.response:360000,' . ApiCacheKey::API_SHOP_CMS . ',' . ApiCacheKey::API_SHOP)->group(function () {
    Route::get('', 'allResources');
